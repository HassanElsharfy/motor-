                ...
                <table id="example" class="table dt-responsive">
                    ...
                    <tbody>
                        @foreach ($slider as $sliders)
                            <tr>
                                <td>{{ $sliders->main_title }}</td>
                                <td>{{ $sliders->description }}</td>
                                <td>{{ $sliders->maintenance_button }}</td>
                                <td>{{ $sliders->materials_button }}</td>
                                <td>{{ $sliders->question }}</td>

                                <td> <img src="{{ asset('filebackgrounds') }}/{{ $sliders->background }}"
                                        alt="{{ $sliders->main_title }}" width="150px" height="50px"></td>

                                <td><img src="{{ asset('filelogos') }}/{{ $sliders->logo }}"
                                        alt="{{ $sliders->main_title }}" width="150px" height="50px"></td>
                                ...
                                <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                    ...
                                    <span style="overflow: visible; position: relative; width: 110px;">
                                        <form method="POST" action="{{ url('/slider' . '/' . $sliders->id) }}"
                                        ...
                                        <a href="{{ url('/slider/' . $sliders->id . '/edit') }}"
                                            class="btn btn-sm btn-clean btn-icon" title="Edit details"><i
                                                class="la la-edit"></i></a>

                                        <a href="{{ url('slider/' . $sliders->id) }}"
